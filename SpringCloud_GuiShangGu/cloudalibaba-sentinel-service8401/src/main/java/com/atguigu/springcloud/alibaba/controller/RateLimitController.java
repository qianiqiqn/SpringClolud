...
public class RateLimitController {
    /**
     * Sentinel 可根据 url 或者 资源名 进行限流控制（增加流控规则）
     * url示例：/rateLimit/byUrl
     * 资源名示例：byUrl
     * @return
     */
    ...
    /**
     * blockHandlerClass = CustomerBlockHandler.class 配置 myhandler 包下的 CustomerBlockHandler类
     * blockHandler = "handlerException2" 指定 CustomerBlockHandler类下的 handlerException2 方法
     * @return
     */
